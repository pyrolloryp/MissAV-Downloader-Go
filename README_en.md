...
This project is continuously updated. The current v1.1.0 version includes the following powerful features:
...
* **🕷️ Intelligent Crawler & Filtering**:
    ...
    * **Smart Priority**: Automatically filters duplicate videos and allows for priority adjustment based on different versions.
...
If this project helps with your technical learning or research, please consider giving it a **Star ⭐ in the top-right corner** of the page.
Every star is motivation to keep this project updated and maintained, and helps others who need it find it.
